...
//function that is triggered when the cone hits the enemy
function OnTriggerEnter(other:Collider)
{
	//if the cone hits the alien, we will do the following two things:
	//Destroy the cone
	//Destroy the alien
...
function OnBecameInvisible()
{
	...
	function Update () {
    //the player cone shooting towards the enemy
    transform.Translate(Vector3.right * coneSpeed * Time.deltaTime);
}
