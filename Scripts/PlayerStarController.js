...
//function that is triggered when the star hits the enemy
function OnTriggerEnter(other:Collider)
{
	//if the star hits the alien, we will do the following two things:
	//Destroy the star
	//Destroy the alien
...
function OnBecameInvisible()
{
	...
	function Update () {
    //the player Star shooting towards the alien
    transform.Translate(Vector3.right * starSpeed * Time.deltaTime);
}